...
(1, '演示', NULL, '2,3,4,5', 'demonstrate', '/category/parent.html', '${category.englishName}.html', 'demonstrate.html', '${content.publishDate?string(''yyyy/MM/dd'')}/${content.id}.html', 10, 0, 0, NULL, NULL, NULL, NULL),
(2, '外链演示', 1, NULL, 'link', '/category/list.html', '${category.englishName}.html', 'link.html', '${content.categoryId}/${content.id}.html', 10, 0, 0, NULL, NULL, NULL, NULL),
(3, '文章图集', 1, NULL, 'article_picture', '/category/list.html', '${category.englishName}.html', 'article_picture.html', '${content.categoryId}/${content.id}.html', 10, 0, 0, NULL, NULL, NULL, NULL),
(4, '图集演示', 1, NULL, 'picture', '/category/list.html', '${category.englishName}.html', 'picture.html', '${content.categoryId}/${content.id}.html', 10, 0, 0, NULL, NULL, NULL, NULL),
(5, '文章演示', 1, NULL, 'article', '/category/list.html', '${category.englishName}.html', 'article.html', '${content.categoryId}/${content.id}.html', 10, 0, 0, NULL, NULL, NULL, NULL);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '管理员', 1, '1', 'master@aaa.com', 0, 1, 0, '', '2015-08-05 17:56:04', '127.0.0.1', 16, '2015-07-06 00:00:00');
