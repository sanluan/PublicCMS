...
INSERT INTO `sys_dept` (`id`, `name`, `parent_id`, `description`, `user_id`) VALUES
(1, '总公司', NULL, '集团总公司', 1);
...
INSERT INTO `sys_moudle` (`id`, `name`, `url`, `authorized_url`, `parent_id`) VALUES
...
(18, '系统维护', '', NULL, 6),
(19, '模块管理', 'sysMoudle/list', NULL, 18),
(20, '添加修改', 'sysMoudle/save', NULL, 19),
(21, '删除', 'sysMoudle/delete', NULL, 19),
(22, '用户管理', '', NULL, 7),
(23, '用户管理', 'sysUser/list', NULL, 22),
(24, '部门管理', 'sysDept/list', NULL, 22),
(25, '角色管理', 'sysRole/list', NULL, 22),
(26, '日志管理', '', NULL, 7),
...
INSERT INTO `sys_role` (`id`, `name`, `owns_all_right`) VALUES
(1, '超级管理员', 1),
(2, '测试管理员', 0);
...
INSERT INTO `sys_role_authorized` (`id`, `role_id`, `authorized_url`) VALUES
(1, 2, 'menus'),
(2, 2, 'index'),
(3, 2, 'myself/password'),
(4, 2, 'file/upload'),
...
INSERT INTO `sys_role_moudle` (`id`, `role_id`, `moudle_id`) VALUES
(28, 2, 2),
(27, 2, 10),
(26, 2, 9),
(25, 2, 8),
...
INSERT INTO `sys_task` (`id`, `name`, `status`, `cron_expression`, `description`, `content`) VALUES
...
INSERT INTO `sys_user` (`id`, `name`, `password`, `nick_name`, `dept_id`, `roles`, `email`, `email_checked`, `superuser_access`, `disabled`, `auth_token`, `last_login_date`, `last_login_ip`, `login_count`, `date_registered`) VALUES
