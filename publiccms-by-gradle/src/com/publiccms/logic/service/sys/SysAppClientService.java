...
public class SysAppClientService extends BaseService<SysAppClient> {
    ...
    public PageHandler getPage(Integer siteId, String channel, Integer userId, Boolean allowPush, Date startLastLoginDate,
    ...
    public SysAppClient updateStatus(Integer id, boolean status) {
