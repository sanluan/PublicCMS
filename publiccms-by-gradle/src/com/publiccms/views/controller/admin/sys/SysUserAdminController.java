...
public class SysUserAdminController extends BaseController {
    ...
    public String enable(Integer id, String repassword, HttpServletRequest request, HttpSession session, ModelMap model) {
        ...
        SysUser entity = service.updateStatus(id, false);
        if (notEmpty(entity)) {
    ...
    public String disable(Integer id, String repassword, HttpServletRequest request, HttpSession session, ModelMap model) {
        ...
        SysUser entity = service.updateStatus(id, true);
        if (notEmpty(entity)) {
    ...
    protected boolean virifyEquals(String field, SysUser user, Integer value2, ModelMap model) {
