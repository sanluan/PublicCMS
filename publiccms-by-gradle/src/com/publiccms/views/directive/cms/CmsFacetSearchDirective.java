...
public class CmsFacetSearchDirective extends AbstractTemplateDirective {
    ...
    public void execute(RenderHandler handler) throws IOException, Exception {
        ...
        if (notEmpty(word) || notEmpty(tagId)) {
            PageHandler page = service.facetQuery(getSite(handler).getId(), handler.getString("categoryId"),
                    handler.getString("modelId"), word, tagId, handler.getInteger("pageIndex", 1),
