...
public class SysTaskAdminController extends BaseController {
    @Autowired
    ...
    public String pause(Integer id, HttpServletRequest request, HttpSession session) {
        SysTask entity = service.updateStatus(id, ScheduledTask.TASK_STATUS_PAUSE);
        if (notEmpty(entity)) {
    ...
    public String resume(Integer id, HttpServletRequest request, HttpSession session) {
        SysTask entity = service.updateStatus(id, ScheduledTask.TASK_STATUS_READY);
        if (notEmpty(entity)) {
    ...
    public String delete(Integer id, HttpServletRequest request, HttpSession session) {
        SysTask entity = service.delete(id);
        if (notEmpty(entity)) {
