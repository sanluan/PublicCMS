 ...
 */
abstract class LayoutCommonTable extends SubTable {
    ...
    abstract static class Builder<T extends LookupTable> extends SubTable.Builder<LayoutCommonTable> {
        ...
        protected int subSerialize(WritableFontData newData) {
            ...
            serializedLookupListBuilder.subSerialize(newData.slice(pos));
        ...
        @Override
        protected abstract LayoutCommonTable subBuildTable(ReadableFontData data);
    }
}
