 ...
 * @author Stuart Gill
 */
public abstract class Subsetter {
     ...
     * order of priority and the number parameter gives a count of how many of
     * the list should be put into the subsetted font. If there are no matches
     * in the font for any of the provided cmap ids which would lead to a font
     * with no cmap then an error will be thrown during subsetting.
     *
     * The two most common cases would be: <list>
     * <ul>
     * a list of one or more cmap ids with a count setting of 1 <br>
     * This will use the list of cmap ids as an ordered priority and look for an
     * available cmap in the font that matches the requests. Only the first such
     * match will be placed in the subsetted font.
     * </ul>
     * <ul>
     ...
     *
     * @param cmapIds
     *            the cmap ids to use for the subsetted font
     * @param number
