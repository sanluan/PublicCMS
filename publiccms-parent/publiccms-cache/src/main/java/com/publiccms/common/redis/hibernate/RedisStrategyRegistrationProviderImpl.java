...
public class RedisStrategyRegistrationProviderImpl implements StrategyRegistrationProvider {
    ...
    public Iterable<StrategyRegistration<?>> getStrategyRegistrations() {
        ...
        strategyRegistrations.add(new SimpleStrategyRegistrationImpl<RegionFactory>(RegionFactory.class, RedisRegionFactory.class,
                "redis", RedisRegionFactory.class.getName(), RedisRegionFactory.class.getSimpleName(),
        ...
        strategyRegistrations.add(new SimpleStrategyRegistrationImpl<RegionFactory>(RegionFactory.class,
                ...
                SingletonRedisRegionFactory.class.getSimpleName(), "com.publiccms.common.redis.hibernate.RedisRegionFactory"));
