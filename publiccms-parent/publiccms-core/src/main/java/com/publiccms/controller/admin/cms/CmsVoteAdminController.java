...
public class CmsVoteAdminController {
    ...
    public String save(@RequestAttribute SysSite site, @SessionAttribute SysUser admin, CmsVote entity,
        ...
        if (null != entity.getId()) {
            ...
            logOperateService.save(new LogOperate(site.getId(), admin.getId(), admin.getDeptId(),
                    LogLoginService.CHANNEL_WEB_MANAGER, "update.cmsVote", RequestUtils.getIpAddress(request), CommonUtils.now(),
            ...
            logOperateService
                    .save(new LogOperate(site.getId(), admin.getId(), admin.getDeptId(), LogLoginService.CHANNEL_WEB_MANAGER,
                            "save.cmsVote", RequestUtils.getIpAddress(request), CommonUtils.now(), JsonUtils.getString(entity)));
        }
    ...
    public String delete(@RequestAttribute SysSite site, @SessionAttribute SysUser admin, Long[] ids,
        ...
        if (CommonUtils.notEmpty(ids)) {
            ...
            logOperateService.save(new LogOperate(site.getId(), admin.getId(), admin.getDeptId(),
                    LogLoginService.CHANNEL_WEB_MANAGER, "delete.cmsVote", RequestUtils.getIpAddress(request), CommonUtils.now(),
                    CommonUtils.joinString(ids, ',')));
        }
        return CommonConstants.TEMPLATE_DONE;
    }
