...
/**
 * LogVisitDayId generated by hbm2java
 */
@Embeddable
public class LogVisitDayId  implements java.io.Serializable {
    ...
    public LogVisitDayId() {
    }

    public LogVisitDayId(short siteId, Date visitDate, byte visitHour) {
       this.siteId = siteId;
