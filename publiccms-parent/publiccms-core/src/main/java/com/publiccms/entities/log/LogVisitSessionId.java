...
/**
 * LogVisitSessionId generated by hbm2java
 */
@Embeddable
public class LogVisitSessionId implements java.io.Serializable {
    ...
    */
    ...
    public LogVisitSessionId() {
    }

    public LogVisitSessionId(short siteId, String sessionId, Date visitDate) {
        this.siteId = siteId;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof LogVisitSessionId))
            return false;
        LogVisitSessionId castOther = (LogVisitSessionId) other;
