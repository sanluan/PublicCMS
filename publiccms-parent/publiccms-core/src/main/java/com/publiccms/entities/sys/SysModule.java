...
/**
 * SystemModule generated by hbm2java
 */
@Entity
...
public class SysModule implements java.io.Serializable {
    ...
    public SysModule(String name, boolean menu, int sort) {
        this.name = name;
        this.menu = menu;
        this.sort = sort;
    }

    public SysModule(String name, String url, String authorizedUrl, String attached, Integer parentId, boolean menu, int sort) {
        this.name = name;
        this.url = url;
