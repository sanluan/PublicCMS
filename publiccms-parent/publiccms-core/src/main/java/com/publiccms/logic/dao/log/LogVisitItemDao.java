 ...
 */
@Repository
public class LogVisitItemDao extends BaseDao<LogVisitItem> {
    ...
    public PageHandler getPage(short siteId, Date startVisitDate, Date endVisitDate, String itemType, String itemId,
        ...
        QueryHandler queryHandler = getQueryHandler("from LogVisitItem bean");
    ...
    public int delete(Date begintime) {
        if (null != begintime) {
            QueryHandler queryHandler = getQueryHandler("delete from LogVisitItem bean");
            if (null != begintime) {
    ...
    @Override
    protected LogVisitItem init(LogVisitItem entity) {
        return entity;
    }
