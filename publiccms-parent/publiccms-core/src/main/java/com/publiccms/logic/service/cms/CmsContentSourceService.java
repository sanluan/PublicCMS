...
public class CmsContentSourceService extends BaseService<CmsContentSource> {
    ...
    public PageHandler getPage(Short siteId, String name, Long userId, String orderType, Integer pageIndex, Integer pageSize) {
        return dao.getPage(siteId, name, userId, orderType, pageIndex, pageSize);
    }
