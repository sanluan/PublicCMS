 ...
 * <pre>
&lt;script&gt;
fetch('${site.dynamicPath!}api/contentCreate?categoryId=1&amp;modelId=article&amp;title=title&amp;text=%3Cdiv%3Econtent%3C/div%3E&amp;extendData.field1=value1&amp;extendData.field2=value2',{"headers":{"appToken":"接口访问授权Token""authToken":"用户登录授权","authUserId":"1"}}).then(res => res.json()).then(data=>{
