 ...
 * <pre>
&lt;script&gt;
 fetch('${site.dynamicPath}api/directive/tools/diyMetadata?itemType=region&amp;itemId=00000000-0000-0000-0000-000000000000',{"headers":{"appToken":"接口访问授权Token"}}).then(res => res.json()).then(data=>{
