...
-- ----------------------------
-- Table structure for sys_certification
-- ----------------------------
DROP TABLE IF EXISTS `sys_certification`;
...
INSERT INTO `sys_module` VALUES ('account_history_list', 'tradeAccountHistory/list', NULL, 'icon-book', 'trade_menu', 1, 7);
...
INSERT INTO `sys_module` VALUES ('category_type_list', 'cmsCategoryType/list', 'cmsCategoryType/categoryList', 'icon-road', 'config_menu', 1, 2);
...
INSERT INTO `sys_module` VALUES ('content_check', 'cmsContent/uncheck_list', 'cmsContent/check,cmsContent/reject', 'icon-check-sign', 'content_menu', 1, 1);
...
INSERT INTO `sys_module` VALUES ('content_recycle_list', 'cmsRecycleContent/list', NULL, 'icon-trash', 'content_menu', 1, 11);
...
INSERT INTO `sys_module` VALUES ('diy_list', 'cmsDiy/list', 'cmsDiy/region,cmsDiy/layout,cmsDiy/module,cmsDiy/saveRegion,cmsDiy/saveLayout,cmsDiy/saveModule,cmsDiy/delete', 'icon-dashboard', 'file_menu', 1, 5);
...
INSERT INTO `sys_module` VALUES ('log_login', 'log/login', NULL, 'icon-signin', 'log_menu', 1, 3);
...
INSERT INTO `sys_module` VALUES ('log_operate', 'log/operate', NULL, 'icon-list-alt', 'log_menu', 1, 2);
...
INSERT INTO `sys_module` VALUES ('order_list', 'tradeOrder/list', NULL, 'icon-barcode', 'trade_menu', 1, 1);
...
INSERT INTO `sys_module` VALUES ('page_list', 'cmsPage/list', 'cmsPage/metadata', 'icon-globe', 'page_menu', 1, 1);
...
INSERT INTO `sys_module` VALUES ('payment_list', 'tradePayment/list', 'tradePayment/refund,tradePayment/refuse', 'icon-money', 'trade_menu', 1, 3);
...
INSERT INTO `sys_module` VALUES ('place_list', 'cmsPlace/list', NULL, 'icon-list-alt', 'page_menu', 1, 2);
...
INSERT INTO `sys_module` VALUES ('place_template_list', 'placeTemplate/list', 'placeTemplate/directory', 'icon-list-alt', 'file_menu', 1, 2);
...
INSERT INTO `sys_module` VALUES ('report_visit', 'report/visit', NULL, 'icon-bolt', 'visit_menu', 1, 0);
...
INSERT INTO `sys_module` VALUES ('tag_list', 'cmsTag/list', NULL, 'icon-tag', 'content_menu', 1, 5);
...
INSERT INTO `sys_module` VALUES ('trade_menu', NULL, NULL, 'icon-money', 'content', 1, 2);
...
INSERT INTO `sys_module` VALUES ('vote_list', 'cmsVote/list', NULL, 'icon-ticket', 'content_menu', 1, 7);
...
-- ----------------------------
-- Table structure for sys_user_certification
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_user_collection
-- ----------------------------
DROP TABLE IF EXISTS `sys_user_collection`;
