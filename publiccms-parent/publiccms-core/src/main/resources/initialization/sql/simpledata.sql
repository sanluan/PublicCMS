...
INSERT INTO `cms_category` VALUES ('19', '1', '案例', null, null, null, '', 'case', '/category/parent.html', '${category.code}/index.html', '0', '1', '//www.publiccms.com/case/index.html', '${content.publishDate?string(\'yyyy/MM/dd\')}/${content.id}.html', '1', '20', '0', '0', '0', '0', '2');
INSERT INTO `cms_category` VALUES ('20', '2', '热门楼盘', NULL, NULL, NULL, '', 'houses', NULL, 'category.html?id=${category.id}', '0', '0', '//hainan.publiccms.com/category.html?id=34', 'content.html?id=${content.id}', '1', '12', '0', '0', '0', '0', null);
