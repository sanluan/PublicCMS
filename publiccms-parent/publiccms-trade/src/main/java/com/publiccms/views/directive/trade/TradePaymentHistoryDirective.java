 ...
 * <pre>
 &lt;script&gt;
  fetch('${site.dynamicPath}api/directive/trade/paymentHistory?id=1',{"headers":{"appToken":"接口访问授权Token"}}).then(res => res.json()).then(data=>{    
    ...
    public void execute(RenderHandler handler) throws IOException, TemplateException {
        ...
        if (CommonUtils.notEmpty(id)) {
            ...
            if (CommonUtils.notEmpty(ids)) {
                ...
                Map<String, TradePaymentHistory> map = CommonUtils.listToMapSorted(entityList, k -> k.getId().toString(), null,
