...
( function($) {
    ...
    $.fn.extend({
        ...
        layoutH: function($refBox) {
            return this.each(function() {
                ...
                if ($this.parents('.page').length != 0 ) {
                	iLayoutH = $this.getSiblingsElemsH();
            	}
         ...
         * 获取page中的其他元素的总高度
         */
        getSiblingsElemsH: function() {
        	var height = 0;
        	var $page = this.parents('.page');
        	
        	var headerH = $page.find('.pageHeader').length == 0 ? 0 : ( this.find('.pageHeader').length == 0 ? $page.find('.pageHeader').outerHeight(true) : 0);
        	var formBarH = $page.find('.formBar').length == 0 ? 0 : ( this.find('.formBar').length == 0 ? $page.find('.formBar').outerHeight(true) : 0);
        	var contentTitleH = $page.find('.contentTitle').length == 0 ? 0 : ( this.find('.contentTitle').length == 0 ? $page.find('.contentTitle').outerHeight(true) : 0);
        	var tabsHeaderH = $page.find('.tabsHeader').length == 0 ? 0 : ( this.find('.tabsHeader').length == 0 ? $page.find('.tabsHeader').outerHeight(true) : 0);
        	var pageBarH = $page.find('.pageBar.panelBar').length == 0 ? 0 : ( this.find('.pageBar.panelBar').length == 0 ? $page.find('.pageBar.panelBar').outerHeight(true) : 0);
        	var panelBarH = $page.find('.panelBar:not(.pageBar)').length == 0 ? 0 : ( this.find('.panelBar:not(.pageBar)').length == 0 ? $page.find('.panelBar:not(.pageBar)').outerHeight(true) : 0);
