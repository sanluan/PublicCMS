...
var DWZ = {
    ...
    init: function(pageFrag, options) {
        ...
        $.ajax({
            type: 'GET', url: pageFrag, dataType: 'html', async: false, cache: false, error: function(xhr) {
...
function initUI(_box) {
    ...
    // init styles
    $("input[type=text], input[type=number], input[type=password], textarea", $p).addClass("textInput");
